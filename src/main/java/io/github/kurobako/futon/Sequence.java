 ...
 * <p>{@link #bind(Function)} and {@link #sequence(A)} form a monad.</p>
...
public abstract class Sequence<A> implements Semigroup<Sequence<A>>, Foldable<A>, Iterable<A> {
   ...
   * @param function <b>A -&gt; Sequence&lt;B&gt;</b> transformation. Can't be null.
   * @param <B> new element type.
   * @return transformed Sequence. Can't be null.
   * @throws NullPointerException if the argument was null.
   */
  public @Nonnull <B> Sequence<B> bind(final Function<? super A, ? extends Sequence<B>> function) {
    nonNull(function);
    return foldLeft((seq, a) -> seq.append(function.$(a)), sequence());
  }
